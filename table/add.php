                                                ...
                                                <div class="col-md-12">
                                                    <form method="post" action="process.php?action=add">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="tableInput" name="table" aria-describedby="tableHelp" placeholder="Enter table number" onkeydown="this.value=this.value.toUpperCase()" required >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="seatsInput">Seats</label>
                                                            <input type="number" class="form-control" id="seatsInput" name="seats" aria-describedby="seatsHelp" placeholder="Enter Your seats" required >
