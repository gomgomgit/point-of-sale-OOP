...
$order = new Order;
$order_detail = $order->order_by_id($id);

$item = new Item;
$data_item = $item->show_data();

$table = new Table;
$row_table = $table->get_by_id($order_detail['table_number']);
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <!-- <form action=""> -->
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" value="1" name="qty" class="form-control qty qty-<?=$iwc['id']?>" onChange="qty_change('<?=$iwc['id']?>', '<?=$iwc['price']?>')" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                                            </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card Recent-Users">
                                    ...
                                    <div class="card-block table-border-style">
                                        ...
                                        <form action="process.php?action=add-detail" method="post">
                                            <div class="d-flex justify-content-between align-items-end">

                                                <!-- Input table number and user -->
                                                <div class="">
                                                    <label for="tableInput">Table Number :
                                                    <input type="text" class="form-control-plaintext m-2 font-weight-bold form-control-lg" id="tableInput" name="table" aria-describedby="emailHelp" placeholder="Enter Table Number" value="<?=$row_table['number'].' with '.$row_table['seats'].' seats' ?>" readonly required></label>
                                                </div>
                                                <input type="hidden" name="order" value="<?=$order_detail['id']?> ">
