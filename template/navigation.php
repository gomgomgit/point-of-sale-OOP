    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item home-nav">
                    <a href="../home/index.php" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Home</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                    <label>Data</label>
                </li>
                <li data-username="Table bootstrap datatable footable" class="nav-item user-nav">
                    <a href="../user/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">User</span></a>
                </li>
                <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item category-nav">
                    <a href="../category/index.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-list"></i></span><span class="pcoded-mtext">Category</span></a>
                </li>
